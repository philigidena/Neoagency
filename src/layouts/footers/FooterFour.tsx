...
const FooterFour = () => {
   ...
   // Pages with light backgrounds that need dark footer text
   const lightBackgroundPages = ['/contact', '/service', '/team', '/about', '/portfolio'];
   const isLightBackground = lightBackgroundPages.includes(location.pathname);
   const textColor = isLightBackground ? 'rgba(10, 30, 21, 0.7)' : 'rgba(255, 255, 255, 0.7)';
   const linkColor = isLightBackground ? '#2c6e49' : '#91ed91';
                        ...
                        <div className="row align-items-center">
                           <div className="col-lg-4">
                              <div className="td-footer-copyright mb-25">
                                 <p style={{ color: textColor }}>© 2025 <Link to="#" style={{ color: linkColor }}>Neo Marketing.</Link> All Rights Reserved.</p>
                              </div>
                           </div>
                           <div className="col-lg-5">
                              <div className="td-footer-3-menu td-footer-4-menu mb-25">
                                 <ul>
                                    <li><Link to="/portfolio" style={{ color: textColor }}>Portfolio</Link></li>
                                    <li><Link to="/service" style={{ color: textColor }}>Services</Link></li>
                                    <li><Link to="/about" style={{ color: textColor }}>About</Link></li>
                                    <li><Link to="/blog" style={{ color: textColor }}>Blog</Link></li>
                                    <li><Link to="/contact" style={{ color: textColor }}>Contact</Link></li>
                                 </ul>
                              </div>
                           </div>
                           <div className="col-lg-3">
